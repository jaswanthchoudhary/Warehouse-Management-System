...
public class ProductController {
    ...
    @GetMapping("/get")
    public List<Product> getAllProductsa(){
        return service.getAllProducts();
    }
    ...
    public Product getProductByIda(@PathVariable Long productId){
        return service.getProductById(productId);
    }
    ...
    @PostMapping("/dispatch/{productId}")
    public ResponseEntity<String> dispatcha(@PathVariable Long productId, @RequestBody Product product){
        service.dispatchProduct(productId,product);
        return ResponseEntity.ok("Dispatched");
    }
